...
- The class syntax introduced in ES6 is essentially syntactic sugar over constructor functions. The constructor method in a class serves the same purpose as a constructor function, but with a more modern and cleaner syntax.
...
// Constructor function
function tr() {
    this.library = 'React';    // Creates properties on the instance
    this.server = 'Node';
    this.bro = 'bro';
}
const tr1 = new tr();          // Creates new instance

// Class (modern way to write constructor functions)
class tr2 {
...
const tr21 = new tr2();        // Creates new instance
```
...
- `this` keyword is used to tell the setName function to pass the `this` context of setName function to the createUser function.
