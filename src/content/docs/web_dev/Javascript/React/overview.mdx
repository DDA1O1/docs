...
1. **Unnecessary Context Usage**
```jsx
// ❌ Don't use context for data needed by only a few components
// ✅ Use props instead for shallow component trees
```

2. **Provider Value Changes**
```jsx
